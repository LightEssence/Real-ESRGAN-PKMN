...
def main():
    ...
    parser.add_argument(
        ...
        '--model_name',
        type=str,
        default='1x_ReFocus_Cleanly_100000_G',
        help=('Model names: 1x_ReFocus_Cleanly_100000_G | RealESRNet_x4plus | RealESRGAN_x4plus_anime_6B | RealESRGAN_x2plus | '
    ...
    if args.model_name in ['1x_ReFocus_Cleanly_100000_G', '1x_ReFocus_Cleanly_100000_G']:  # x4 RRDBNet model
